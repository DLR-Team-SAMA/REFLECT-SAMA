...
def state_detector(vlm_model, image, rois, plan, plan_state, curr_task, curr_task_state, message_history=[]):  #Edge - change prompt to edge from states, #Scene graph, object list - remove ROI's and objects
...
if __name__ == '__main__':
  ...
  rsp = state_detector(model, image, rois_,  'plan',plan_state, 'curr_task', curr_task_state)
